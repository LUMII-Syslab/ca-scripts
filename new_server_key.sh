...
${OQS_OPENSSL} x509 -req -in server.csr -out ${DIR}/server.crt -CA ${CA_CRT} -CAkey ${CA_KEY} -CAcreateserial -days ${DAYS} -extensions v3_req -extfile ${SERVER_CONFIG_FILE} ${OQS_OPENSSL_FLAGS}
